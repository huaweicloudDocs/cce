...
3.  在创建节点池页面中，参照[表1](#table8638121213265)设置节点池选型参数，其中带“\*”的参数为必填参数。
    ...
    **表 1**  添加节点池参数配置
    ...
    <p id="p9680175204915"><a name="p9680175204915"></a><a name="p9680175204915"></a>单击<a name="image16680652104914"></a><a name="image16680652104914"></a><span><img id="image16680652104914" src="figures/zh-cn_image_0184191819.png"></span>开启<span class="uicontrol" id="uicontrol17680135213496"><a name="uicontrol17680135213496"></a><a name="uicontrol17680135213496"></a>“弹性扩缩容”</span>后，节点池将根据业务需求自动创建或删除节点池内的节点，参数设置如下：</p>
