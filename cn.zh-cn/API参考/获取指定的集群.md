...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.2.4.1.3 "><p id="p102271654195515"><a name="p102271654195515"></a><a name="p102271654195515"></a><span id="ph4553432814"><a name="ph4553432814"></a><a name="ph4553432814"></a>metadata是集群对象的元数据定义，是集合类的元素类型，包含一组由不同名称定义的</span><span id="ph193518533294"><a name="ph193518533294"></a><a name="ph193518533294"></a>属性。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.2.4.1.3 "><p id="p10785112129"><a name="p10785112129"></a><a name="p10785112129"></a><span id="ph1962215421378"><a name="ph1962215421378"></a><a name="ph1962215421378"></a>spec是集合类的元素类型，用户对需要管理的集群对象进行详细描述的主体部分都在spec中给出。</span><span id="ph6395154184218"><a name="ph6395154184218"></a><a name="ph6395154184218"></a>系统通过spec的描述来创建或更新对象。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.2.4.1.3 "><p id="p746612118311"><a name="p746612118311"></a><a name="p746612118311"></a><span id="ph6811014102514"><a name="ph6811014102514"></a><a name="ph6811014102514"></a>status是集合类的元素类型，用于记录对象在系统中的当前状态信息</span><span id="ph26102344718"><a name="ph26102344718"></a><a name="ph26102344718"></a>，包含了集群状态和本次创建集群作业的jobID</span></p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.2.4.1.3 "><p id="p8749534142216"><a name="p8749534142216"></a><a name="p8749534142216"></a>集群变为当前状态的原因<span id="ph17325735162710"><a name="ph17325735162710"></a><a name="ph17325735162710"></a>，在集群在非“Available”状态下时，会返回此参数。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.2.4.1.3 "><p id="p48271730459"><a name="p48271730459"></a><a name="p48271730459"></a>集群变为当前状态的原因的详细信息<span id="ph88474632818"><a name="ph88474632818"></a><a name="ph88474632818"></a>，在集群在非“Available”状态下时，会返回此参数。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52.475247524752476%" headers="mcps1.2.4.1.3 "><p id="p7974103611299"><a name="p7974103611299"></a><a name="p7974103611299"></a><span id="ph365275064210"><a name="ph365275064210"></a><a name="ph365275064210"></a>集群中 kube-apiserver 的访问地址</span>的路由</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52.475247524752476%" headers="mcps1.2.4.1.3 "><p id="p14349012766"><a name="p14349012766"></a><a name="p14349012766"></a><span id="ph3608102112435"><a name="ph3608102112435"></a><a name="ph3608102112435"></a>集群中 kube-apiserver 的访问地址</span>的类型：</p>
