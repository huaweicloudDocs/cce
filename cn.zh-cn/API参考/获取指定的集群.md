...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.2.4.1.3 "><p id="p102271654195515"><a name="p102271654195515"></a><a name="p102271654195515"></a>集群对象的元数据定义，是集合类的元素类型，包含一组由不同名称定义的属性。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.2.4.1.3 "><p id="p10785112129"><a name="p10785112129"></a><a name="p10785112129"></a>集合类的元素类型，用户对需要管理的集群对象进行详细描述的主体部分都在spec中给出。系统通过spec的描述来创建或更新对象。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.2.4.1.3 "><p id="p746612118311"><a name="p746612118311"></a><a name="p746612118311"></a>集合类的元素类型，用于记录对象在系统中的当前状态信息，包含了集群状态和本次创建集群作业的jobID</p>
</td>
</tr>
</tbody>
</table>
