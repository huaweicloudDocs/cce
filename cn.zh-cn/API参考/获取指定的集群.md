...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p><a href="#response_ShowClusterMetadata">ShowClusterMetadata</a> object</p>
</td>
...
**表 5**  ShowClusterMetadata

<a name="response_ShowClusterMetadata"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p>参数类型</p>
</th>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>集群注解。此字段与创建时的annotations无必然关系，查询时根据查询参数返回集群相关信息存入该字段中。</p>
<p>当查询参数detail设置为true时，该注解包含集群下节点总数(totalNodesNumber)、正常节点数(activeNodesNumber)、CPU总量(totalNodesCPU)、内存总量(totalNodesMemory)和已安装插件名称(installedAddonInstances)。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>集群创建时间，集群创建成功后自动生成，填写无效</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>集群更新时间，集群创建成功后自动生成，填写无效</p>
</td>
</tr>
...
<p>该字段值由系统自动生成，用于升级时前端识别集群支持的特性开关，用户指定无效，与创建时的labels无必然关系。</p>
</td>
</tr>
</tbody>
</table>
