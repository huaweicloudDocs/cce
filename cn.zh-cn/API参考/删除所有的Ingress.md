...
DELETE /apis/networking.k8s.io/v1beta1/namespaces/\{namespace\}/ingresses \(Supports since1.15\)

DELETE /apis/extensions/v1beta1/namespaces/\{namespace\}/ingresses \(Compatible\)
