...
<td class="cellrowborder" valign="top" width="42.15686274509804%" headers="mcps1.2.5.1.4 "><p id="p555711530309"><a name="p555711530309"></a><a name="p555711530309"></a><span id="ph4553432814"><a name="ph4553432814"></a><a name="ph4553432814"></a>metadata是节点对象的元数据定义，是集合类的元素类型，包含一组由不同名称定义的</span><span id="ph193518533294"><a name="ph193518533294"></a><a name="ph193518533294"></a>属性。（必须包含，不可缺少）</span></p>
</td>
</tr>
</tbody>
</table>
