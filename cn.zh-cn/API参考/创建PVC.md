...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>Namespace是对一组资源和对象的抽象集合，用来将系统内部的对象划分为不同的项目组或用户组。以小写字母开头，由小写字母、数字、中划线（-）组成，且不能以中划线（-）结尾。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>API类型，固定值<strong>PersistentVolumeClaim</strong></p>
<p>缺省值：PersistentVolumeClaim</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>metadata是集群对象的元数据定义，是集合类的元素类型，包含一组由不同名称定义的属性。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>spec是集合类的元素类型，用户对需要管理的集群对象进行详细描述的主体部分都在spec中给出。系统通过spec的描述来创建或更新对象。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>status是当前PersistentVolumeClaim的状态信息，创建时不需要添加status参数。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>PersistentVolumeClaim名称，可以包含小写字母、数字、连字符和点，开头和结尾必须是字母或数字，最长253个字符，同一namespace下name不能重复。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>PersistentVolumeClaim标签，key/value对格式。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>资源需为已经存在的存储资源</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>云存储的类型，和volumeID搭配使用。即volumeID和storageType必须同时被配置。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>指定volume应该具有的访问模式，列表中仅第一个配置参数有效。</p>
...
<p>枚举值：</p>
<ul><li><p>ReadOnlyMany</p>
</li><li><p>ReadWriteMany</p>
</li></ul>
</td>
</tr>
</tbody>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>底层卷的实际资源</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>PersistentVolumeClaim当前所处的状态</p>
</td>
</tr>
</tbody>
</table>
