...
Token可通过调用[获取用户Token](https://support.huaweicloud.com/api-iam/iam_30_0001.html)[获取用户Token](https://docs.prod-cloud-ocb.orange-business.com/zh-cn/api/iam/zh-cn_topic_0057845583.html)[获取请求认证](https://docs.otc.t-systems.com/en-us/api/iam/en-us_topic_0057845583.html)接口获取，调用本服务API需要project级别的Token，即调用[获取用户Token](https://support.huaweicloud.com/api-iam/iam_30_0001.html)[获取用户Token](https://docs.prod-cloud-ocb.orange-business.com/zh-cn/api/iam/zh-cn_topic_0057845583.html)[获取请求认证](https://docs.otc.t-systems.com/en-us/api/iam/en-us_topic_0057845583.html)接口时，请求body中auth.scope的取值需要选择project，如下所示。
