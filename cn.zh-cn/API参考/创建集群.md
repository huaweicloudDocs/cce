...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>API类型，固定值“Cluster”或“cluster”，该值不可修改。</p>
<p>缺省值：Cluster</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群的基本信息，为集合类的元素类型，包含一组由不同名称定义的属性。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>spec是集合类的元素类型，您对需要管理的集群对象进行详细描述的主体部分都在spec中给出。CCE通过spec的描述来创建或更新对象。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集合类的元素类型，用于记录对象在系统中的当前状态信息，包含了集群状态和本次创建集群作业的jobID</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群名称。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群注解，由key/value组成：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群标签，key/value对格式。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群创建时间</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群更新时间</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群类型：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>字段默认值：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群版本，与Kubernetes社区基线版本保持一致，建议选择最新版本。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群描述，对于集群使用目的的描述，可根据实际情况自定义，默认为空。集群创建成功后可通过接口<a href="https://support.huaweicloud.com/api-cce/cce_02_0240.html" target="_blank" rel="noopener noreferrer">更新指定的集群</a>来做出修改，也可在CCE控制台中对应集群的“集群详情”下的“描述”处进行修改。仅支持utf-8编码。</p>
<p>最小长度：0</p>
<p>最大长度：200</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群是否使用IPv6模式，1.15版本及以上支持。</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>offloadCluster</p>
</td>
<td class="cellrowborder" valign="top" width="10%" headers="mcps1.2.5.1.2 "><p>否</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>Boolean</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>CCE Turbo集群(公测)</p>
<p>缺省值：false</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点网络参数，包含了虚拟私有云VPC和子网的ID信息，而VPC是集群内节点之间的通信依赖，所以是必选的参数集。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>容器网络参数，包含了容器网络类型和容器网段的信息。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>Yangtse网络配置，创建CCE Turbo集群（公测中）时指定。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群认证方式相关配置。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群的计费方式，当前接口只支持创建“按需计费”的集群。计费方式为“按需计费”时，取值为“0”。若不填，则默认为“0”。</p>
<p>缺省值：0</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>控制节点的高级配置</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>服务网段参数，kubernetes clusterIp取值范围，1.11.7版本及以上支持。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群资源标签</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>服务转发模式，支持以下两种实现：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>可用区（仅查询返回字段）</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>扩展字段，key/value对格式。可配置多可用区集群、专属混合集群，以及将集群创建在特定的企业项目下。可配置的key/value对如下：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>支持Istio</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>用于创建控制节点的VPC的ID。该值在<a href="https://support.huaweicloud.com/api-cce/cce_02_0100.html" target="_blank" rel="noopener noreferrer">创建VPC和子网</a>中获取。</p>
<p>获取方法如下：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>用于创建控制节点的subnet的网络ID。获取方法如下：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>用于创建裸金属节点的高速网络的子网ID。该值在<a href="https://support.huaweicloud.com/api-cce/cce_02_0270.html" target="_blank" rel="noopener noreferrer">创建高速网络（可选）</a>中获取。创建裸金属集群时该参数为必选参数。</p>
<p>最小长度：0</p>
<p>最大长度：64</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点安全组ID，创建时指定无效</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>容器网络类型（只可选择其一）</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>容器网络网段，建议使用网段10.0.0.0/12~19，172.16.0.0/16~19，192.168.0.0/16~19，如存在网段冲突，将自动重新选择。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>eni子网ID</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>ENI子网CIDR</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群认证模式。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>authenticatingProxy模式相关配置。认证模式为authenticating_proxy时必选。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>authenticating_proxy模式配置的x509格式CA证书(base64编码)。 最大长度：1M</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>可用区</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>flavor</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>规格</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>Key值。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>Value值。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群状态，取值如下</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>作业ID</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群变为当前状态的原因，在集群在非“Available”状态下时，会返回此参数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群变为当前状态的原因的详细信息，在集群在非“Available”状态下时，会返回此参数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p><a href="#request_ClusterEndpoints">ClusterEndpoints</a> object</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群中 kube-apiserver 的访问地址。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>CBC资源锁定</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>CBC资源锁定场景</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>锁定资源</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>锁定的资源ID</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>删除配置状态（仅删除请求响应包含）</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>删除状态信息（仅删除请求响应包含）</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群访问地址的类型</p>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p><a href="#response_ClusterEndpoints">ClusterEndpoints</a> object</p>
</td>
