# 创建PVC（待废弃）<a name="cce_02_0252"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCE&api=CreateCloudPersistentVolumeClaims)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
<ul><li><p>用户自定义的namespace，使用前必须先在集群中创建namespace</p>
