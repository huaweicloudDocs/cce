...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>标明是否为nodepool下发的请求。若不为“NodepoolScaleUp”将自动更新对应节点池的实例数</p>
<p>枚举值：</p>
<ul><li><p>NodepoolScaleUp</p>
</li></ul>
</td>
</tr>
</tbody>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>API类型，固定值“Node”，该值不可修改。</p>
<p>缺省值：Node</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>metadata是节点对象的元数据定义，是集合类的元素类型，包含一组由不同名称定义的属性。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>spec是集合类的元素类型，用户对需要管理的节点对象进行详细描述的主体部分都在spec中给出。系统通过spec的描述来创建或更新对象。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点名称</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>资源唯一标识，创建成功后自动生成，填写无效</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>CCE自有节点标签，非Kubernetes原生labels。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>CCE自有节点注解，非Kubernetes原生annotations，格式为key/value键值对。</p>
<p>示例：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>创建时间，创建成功后自动生成，填写无效</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>更新时间，创建成功后自动生成，填写无效</p>
</td>
</tr>
</tbody>
</table>
