...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>API类型，固定值“Addon”，该值不可修改。</p>
<p>缺省值：Addon</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>API版本，固定值“v3”，该值不可修改。</p>
<p>缺省值：v3</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>基本信息，为集合类的元素类型，包含一组由不同名称定义的属性</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>spec是集合类的元素类型，内容为插件实例安装/升级的具体请求信息</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>唯一id标识</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>插件名称</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>插件标签，key/value对格式</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>插件注解，由key/value组成</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>更新时间</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>创建时间</p>
</td>
</tr>
</tbody>
</table>

**表 5**  InstanceRequestSpec
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>待安装、升级插件的具体版本版本号，例如1.0.0</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群id</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>插件模板安装参数（各插件不同）</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>待安装插件模板名称，如coredns</p>
</td>
</tr>
</tbody>
</table>
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>-</p>
</td>
<td class="cellrowborder" valign="top" width="10%" headers="mcps1.2.5.1.2 "><p>是</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>Map&lt;String,String&gt;</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>插件模板的具体安装参数</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>插件标签，key/value对格式</p>
</td>
</tr>
