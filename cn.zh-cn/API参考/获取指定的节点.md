...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p id="p11691054113017"><a name="p11691054113017"></a><a name="p11691054113017"></a><a href="创建节点.md#table13949117115810">spec</a> object</p>
</td>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p id="p14802164201917"><a name="p14802164201917"></a><a name="p14802164201917"></a><a href="#table10411172218590">annotations</a> object</p>
</td>
...
**表 5**  annotations字段数据结构说明

<a name="table10411172218590"></a>
<table><thead align="left"><tr id="row1741182216599"><th class="cellrowborder" valign="top" width="25%" id="mcps1.2.4.1.1"><p id="p11995558814"><a name="p11995558814"></a><a name="p11995558814"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p id="p719955520812"><a name="p719955520812"></a><a name="p719955520812"></a>参数类型</p>
</th>
<th class="cellrowborder" valign="top" width="55.00000000000001%" id="mcps1.2.4.1.3"><p id="p181994551686"><a name="p181994551686"></a><a name="p181994551686"></a>描述</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="55.00000000000001%" headers="mcps1.2.4.1.3 "><a name="ul1357762005718"></a><a name="ul1357762005718"></a><ul id="ul1357762005718"><li>节点由节点池创建时，为节点池ID。</li><li>节点非节点池创建时，为“节点所在的可用区名#节点的规格#节点的操作系统名”。</li></ul>
</td>
</tr>
</tbody>
</table>
...
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p id="p1996175915440"><a name="p1996175915440"></a><a name="p1996175915440"></a>参数类型</p>
</th>
