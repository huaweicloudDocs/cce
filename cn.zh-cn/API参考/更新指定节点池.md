...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCE&api=UpdateNodePool)中调试该接口。
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>节点的规格，CCE支持的节点规格请参考<a href="https://support.huaweicloud.com/api-cce/cce_02_0368.html" target="_blank" rel="noopener noreferrer">节点规格说明</a>获取。</p>
<p>最小长度：<strong>1</strong></p>
<p>最大长度：<strong>50</strong></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>待创建节点所在的可用区，需要指定可用区（AZ）的名称。CCE支持的可用区请参考<a href="https://developer.huaweicloud.com/endpoint?CCE" target="_blank" rel="noopener noreferrer">地区和终端节点</a>获取。</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>节点的登录方式</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>磁盘初始化配置管理参数。该参数缺省时，按照extendParam中的DockerLVMConfigOverride参数进行磁盘管理。此参数对1.15.11及以上集群版本支持。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>节点的计费模式：取值为 0（按需付费）、1（包周期）、2（自动付费包周期）</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>弹性IP类型，取值请参见“<a href="https://support.huaweicloud.com/api-ecs/zh-cn_topic_0167957246.html" target="_blank" rel="noopener noreferrer">创建云服务器</a></p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>带宽的共享类型，取值请参见“<a href="https://support.huaweicloud.com/api-ecs/zh-cn_topic_0167957246.html" target="_blank" rel="noopener noreferrer">创建云服务器</a></p>
...
<p>节点可以创建多少个Pod，受多个参数影响，具体请参见<a href="https://support.huaweicloud.com/usermanual-cce/cce_01_0348.html" target="_blank" rel="noopener noreferrer">节点最多可以创建多少Pod</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>订购周期类型，取值范围：</p>
<ul><li><p>month：月</p>
</li><li><p>year：年</p>
</li></ul>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>当前节点池中删除中或者删除失败的节点数量。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>节点池每次扩容的动作结果记录，用于确定节点池是否还能继续扩容。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>Condition类型。</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>status</p>
</td>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>Condition当前状态。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>当前节点池中删除中或者删除失败的节点数量。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>节点池每次扩容的动作结果记录，用于确定节点池是否还能继续扩容。</p>
</td>
</tr>
</tbody>
</table>

**表 59**  NodePoolCondition
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>Condition类型。</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>status</p>
</td>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>Condition当前状态。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>表示更新指定节点池成功。</p>
</td>
</tr>
</tbody>
</table>
