...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池ID</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>API类型，固定值“NodePool”。</p>
<p>缺省值：NodePool</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>API版本，固定值“v3”。</p>
<p>缺省值：v3</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池的元数据信息</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池的规格描述</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池状态</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点名池名称。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池的uid。创建成功后自动生成，填写无效</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池类型。不填写时默认为vm。</p>
<ul><li><p>vm：弹性云服务器</p>
</li><li><p>ElasticBMS：C6型弹性裸金属通用计算增强型云服务器，规格示例：c6.22xlarge.2.physical</p>
</li></ul>
<p>枚举值：</p>
<ul><li><p>vm</p>
</li><li><p>ElasticBMS</p>
</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池模板详细参数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池初始化节点个数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>弹性伸缩参数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点管理相关配置</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点的规格</p>
<p>最小长度：1</p>
<p>最大长度：50</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点所在的可用区名. 底层实际存在，位于该用户物理可用区组之内的可用区</p>
<p>最大长度：200</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点的操作系统类型。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点的登录方式</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点的系统盘参数</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点的数据盘参数（目前已支持通过控制台为CCE节点添加第二块数据盘）。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点的公网IP地址。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点网卡的描述信息。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>批量创建时节点的个数，必须为大于等于1，小于等于最大限额的正整数。作用于节点池时该项允许为0</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点的计费模式：取值为 0（按需付费）、2（自动付费包周期）</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>支持给创建出来的节点加Taints来设置反亲和性，每条Taints包含以下3个参数：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>格式为key/value键值对。键值对个数不超过20条。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>云服务器组ID，若指定，将节点创建在该云服务器组下</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>指定DeH主机的ID，将节点调度到自己的DeH上。\n&gt;创建节点池添加节点时不支持该参数。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>是否CCE Turbo集群节点</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>云服务器标签，键必须唯一</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>创建节点时的扩展参数，可选参数如下：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>选择密钥对方式登录时的密钥对名称。密钥对和密码登录方式二者必选其一。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>选择密码方式登录时的帐号密码信息，之后可通过此账号密码登录节点。密钥对和密码登录方式二者必选其一。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>登录帐号，默认为“root”</p>
<p>缺省值：root</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>磁盘大小，单位为GB</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>磁盘类型，取值请参见创建云服务器 中“root_volume字段数据结构说明”。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>磁盘扩展参数，取值请参见<a href="https://support.huaweicloud.com/api-ecs/zh-cn_topic_0020212668.html" target="_blank" rel="noopener noreferrer">创建云服务器</a>中“extendparam”参数的描述。</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>cluster_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>云服务器系统盘对应的存储池的ID。仅用作专属云集群，专属分布式存储DSS的存储池ID，即dssPoolID。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>云服务器系统盘对应的磁盘存储类型。仅用作专属云集群，固定取值为dss。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><ul><li><p>使用SDI规格创建虚拟机时请关注该参数，如果该参数值为true，说明创建的为SCSI类型的卷</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>数据盘加密信息，仅在创建节点数据盘需加密时须填写。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>表示云硬盘加密功能的字段，'0'代表不加密，'1'代表加密。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>用户主密钥ID，是metadata中的表示加密功能的字段，与__system__encrypted配合使用。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>已有的弹性IP的ID列表。数量不得大于待创建节点数</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>要动态创建的弹性IP个数。</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>弹性IP参数</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>弹性IP类型，取值请参见“<a href="https://support.huaweicloud.com/api-ecs/zh-cn_topic_0167957246.html" target="_blank" rel="noopener noreferrer">创建云服务器</a> &gt; eip字段数据结构说明”表中“iptype”参数的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>弹性IP的带宽参数</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>带宽的计费类型：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>带宽大小，取值请参见“<a href="https://support.huaweicloud.com/api-ecs/zh-cn_topic_0167957246.html" target="_blank" rel="noopener noreferrer">创建云服务器</a> &gt; bandwidth字段数据结构说明”表中“size”参数的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>带宽的共享类型，取值请参见“<a href="https://support.huaweicloud.com/api-ecs/zh-cn_topic_0167957246.html" target="_blank" rel="noopener noreferrer">创建云服务器</a> &gt; bandwidth字段数据结构说明”表中“sharetype”参数的描述。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>主网卡的描述信息。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>扩展网卡</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>网卡所在子网的ID。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>主网卡的IP将通过fixedIps指定，数量不得大于创建的节点数。fixedIps或ipBlock同时只能指定一个。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>IP段的CIDR格式，创建的节点IP将属于该IP段内。fixedIps或ipBlock同时只能指定一个。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>键</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>值</p>
<p>最大长度：63</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>作用效果</p>
<p>枚举值：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>云服务器标签的键。不得以"CCE-"或"__type_baremetal"开头</p>
<p>最小长度：1</p>
<p>最大长度：36</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>云服务器标签的值</p>
<p>最小长度：0</p>
<p>最大长度：43</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>是否开启自动扩缩容</p>
<p>缺省值：false</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>若开启自动扩缩容，最小能缩容的节点个数。不可大于集群规格所允许的节点上限</p>
<p>最小值：0</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>若开启自动扩缩容，最大能扩容的节点个数，应大于等于 minNodeCount，且不超过集群规格对应的节点数量上限。</p>
<p>最小值：0</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点保留时间，单位为分钟，扩容出来的节点在这个时间内不会被缩掉</p>
<p>最小值：0</p>
<p>最大值：2147483647</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池权重，更高的权重在扩容时拥有更高的优先级</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>云服务器组ID，若指定，节点池中所有节点将创建在该云服务器组下</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>当前节点池中节点数量</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池状态，可为空。</p>
<p>枚举值：</p>
<ul><li><p>Synchronizing</p>
</li><li><p>Synchronized</p>
</li><li><p>SoldOut</p>
</li><li><p>Deleting</p>
</li><li><p>Error</p>
</li></ul>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>节点池删除时的 JobID</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>云服务器组ID，若指定，节点池中所有节点将创建在该云服务器组下</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>节点池状态，可为空。</p>
<p>枚举值：</p>
<ul><li><p>Synchronizing</p>
</li><li><p>Synchronized</p>
</li><li><p>SoldOut</p>
...
```
{
  ...
  "apiVersion" : "v3",
  "metadata" : {
    "name" : "t00417036-lc-it-nodepool-3",
...
```
{
  ...
  "spec" : {
    ...
    "nodeTemplate" : {
      ...
      "k8sTags" : {
        "cce.cloud.com/cce-nodepool" : "t00417036-lc-it-nodepool-3"
      }
    },
    "autoscaling" : { },
    "nodeManagement" : { }
