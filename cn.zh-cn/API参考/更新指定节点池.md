...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>节点的系统盘信息</p>
</td>
</tr>
...
</li><li><p>dockerBaseSize: Device mapper模式下，节点上Docker单容器的可用磁盘空间大小，OverlayFS模式(CCE Turbo集群中CentOS 7.6和Ubuntu 18.04节点，以及混合集群中Ubuntu 18.04节点)下不支持此字段。</p>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>节点的系统盘信息</p>
</td>
</tr>
