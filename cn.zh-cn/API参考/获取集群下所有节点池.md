...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCE&api=ShowNodePools)中调试该接口。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>是否展示默认节点池。默认不展示，指定为“true”时展示默认节点池。</p>
</td>
</tr>
</tbody>
</table>
