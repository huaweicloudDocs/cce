...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>具体集群参数</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>集群的描述信息。</p>
...
**表 7**  ClusterMetadataCreateRequest
