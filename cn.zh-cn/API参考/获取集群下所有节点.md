...
<td class="cellrowborder" valign="top" width="55.00000000000001%" headers="mcps1.2.4.1.3 "><p id="p256924217343"><a name="p256924217343"></a><a name="p256924217343"></a>节点对象列表，包含了当前集群下所有节点的详细信息。可通过items.metadata.name下的值来找到对应的节点。详情请参见<a href="获取指定的节点.md#zh-cn_topic_0079616779_zh-cn_topic_0079614912_ref458774242">表3</a>。</p>
</td>
</tr>
</tbody>
</table>
