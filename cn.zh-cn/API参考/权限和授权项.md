...
如果您需要对您所拥有的云容器引擎（CCE）进行精细的权限管理，您可以使用统一身份认证服务（Identity and Access Management，简称IAM），如果华为云帐号已经能满足您的要求，不需要创建独立的IAM用户，您可以跳过本章节，不影响您使用CCE服务的其它功能。
...
<td class="cellrowborder" valign="top" width="32.503250325032504%" headers="mcps1.2.6.1.2 "><p id="p12219102172319"><a name="p12219102172319"></a><a name="p12219102172319"></a><span>GET /api/v3/projects/{project_id}/clusters</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="32.503250325032504%" headers="mcps1.2.6.1.2 "><p id="p916681851220"><a name="p916681851220"></a><a name="p916681851220"></a>POST /api/v3/projects/{project_id}/clusters/{cluster_id}/operation/hibernate</p>
</td>
...
<td class="cellrowborder" valign="top" width="32.42%" headers="mcps1.2.6.1.2 "><p id="p1547273216814"><a name="p1547273216814"></a><a name="p1547273216814"></a><span>POST /api/v3/projects/{project_id}/clusters/{cluster_id}/nodes</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="32.35%" headers="mcps1.2.6.1.2 "><p id="p88271134184"><a name="p88271134184"></a><a name="p88271134184"></a><span>DELETE</span> /api/v2/projects/{project_id}/jobs</p>
<p id="p1482713341184"><a name="p1482713341184"></a><a name="p1482713341184"></a><span>DELETE</span> /api/v2/projects/{project_id}/jobs/<span>{job_id}</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="32.43%" headers="mcps1.2.6.1.2 "><p id="p16841342289"><a name="p16841342289"></a><a name="p16841342289"></a>PUT /v2/charts/<span>{</span>id<span>}</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="32.43%" headers="mcps1.2.6.1.2 "><p id="p868434218819"><a name="p868434218819"></a><a name="p868434218819"></a>GET /v2/charts/<span>{</span>id<span>}</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="32.43%" headers="mcps1.2.6.1.2 "><p id="p12685144220812"><a name="p12685144220812"></a><a name="p12685144220812"></a>DELETE /v2/charts/<span>{</span>id<span>}</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="32.61%" headers="mcps1.2.6.1.2 "><p id="p1940320451286"><a name="p1940320451286"></a><a name="p1940320451286"></a>PUT /v2/releases/<span>{name}</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="32.61%" headers="mcps1.2.6.1.2 "><p id="p54041045889"><a name="p54041045889"></a><a name="p54041045889"></a>GET /v2/releases/<span>{name}</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="32.61%" headers="mcps1.2.6.1.2 "><p id="p940418452814"><a name="p940418452814"></a><a name="p940418452814"></a>DELETE /v2/releases/<span>{name}</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="17.46%" headers="mcps1.2.6.1.3 "><p id="p056165916125"><a name="p056165916125"></a><a name="p056165916125"></a><span>cce:storage:delete</span></p>
</td>
