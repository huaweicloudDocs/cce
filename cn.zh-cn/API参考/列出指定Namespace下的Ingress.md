# 列出指定Namespace下的Ingress<a name="cce_02_0264"></a>
...
GET /apis/networking.k8s.io/v1beta1/namespaces/\{namespace\}/ingresses \(Supports since1.15\)

GET /apis/extensions/v1beta1/namespaces/\{namespace\}/ingresses \(Compatible\)
