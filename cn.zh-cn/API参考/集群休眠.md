...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCE&api=HibernateCluster)中调试该接口。

## URI

POST /api/v3/projects/\{project\_id\}/clusters/\{cluster\_id\}/operation/hibernate
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>表示集群休眠任务下发成功，需持续查询集群状态，当集群状态变为Hibernation后表示休眠成功</p>
</td>
</tr>
</tbody>
</table>
