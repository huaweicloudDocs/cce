...
CCE v1.11.3前的集群版本不支持直接创建极速文件存储服务，请参照界面要求创建新版本集群，再使用极速文件存储服务。
...
2.  选择存储类型为“极速文件存储”。
    ...
    **表 1**  极速文件存储参数说明
    ...
    <td class="cellrowborder" valign="top" width="78.78%" headers="mcps1.2.3.1.2 "><p id="p106916420316"><a name="p106916420316"></a><a name="p106916420316"></a>云存储名称：选择已创建的存储，您需要提前导入存储，导入存储步骤请参见<a href="#section1891717507335">导入极速文件存储卷</a>。</p>
    </td>
    </tr>
