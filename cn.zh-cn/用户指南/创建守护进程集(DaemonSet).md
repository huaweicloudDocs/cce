...
2.  在左侧导航栏中选择“工作负载 \> 守护进程集（DaemonSet）”，单击页面右上角的“创建守护进程集”。参照[表1](#table18511927357)设置基本信息，其中带“\*”标志的参数为必填参数。
    ...
    **表 1**  工作负载基本信息
    ...
    <td class="cellrowborder" valign="top" width="76.92999999999999%" headers="mcps1.2.3.1.2 "><p id="p11595204219"><a name="p11595204219"></a><a name="p11595204219"></a>该参数仅在安装virtual kubelet插件后才显示，详情请参见<a href="virtual-kubelet.md">virtual kubelet</a>。</p>
...
5.  单击“下一步“，进行高级设置。
    ...
    -   **Pod高级设置**
        ...
        **图 1**  Pod高级设置<a name="fig2225829163110"></a>  
        ![](figures/Pod高级设置-4.png "Pod高级设置-4")
