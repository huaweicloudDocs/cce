...
2.  参照[表1](#table8638121213265)设置新增集群参数，其中带“\*”的参数为必填参数。
    ...
    **表 1**  创建集群参数配置
    ...
    <div class="fignone" id="fig19782959108"><a name="fig19782959108"></a><a name="fig19782959108"></a><span class="figcap"><b>图1 </b>控制节点可用区选择</span><br><a name="image0463648706"></a><a name="image0463648706"></a><span><img id="image0463648706" src="figures/控制节点可用区选择-0.png" width="413.63" height="53.418253"></span></div>
