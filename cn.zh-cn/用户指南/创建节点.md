...
## 操作步骤<a name="cce_01_0298_section13305183010495"></a>
...
2.  在集群控制台左侧导航栏中选择“节点管理“，单击右侧“创建节点“，在节点配置步骤中参照如下表格设置节点参数。
    ...
    **表 2**  存储配置参数
    ...
    <div class="p" id="cce_01_0028_p196385417139"><a name="cce_01_0028_p196385417139"></a><a name="cce_01_0028_p196385417139"></a>加密：数据盘加密功能可为您的数据提供强大的安全防护，加密磁盘生成的快照及通过这些快照创建的磁盘将自动继承加密功能。<strong id="cce_01_0028_b144941934193913"><a name="cce_01_0028_b144941934193913"></a><a name="cce_01_0028_b144941934193913"></a>目前仅在部分Region显示此选项，具体以界面为准。</strong><a name="cce_01_0028_ul6195114261211"></a><a name="cce_01_0028_ul6195114261211"></a><ul id="cce_01_0028_ul6195114261211"><li>默认不加密。</li><li>点选<span class="uicontrol" id="cce_01_0028_uicontrol1719514421129"><a name="cce_01_0028_uicontrol1719514421129"></a><a name="cce_01_0028_uicontrol1719514421129"></a>“加密”</span>后，可在弹出的<span class="uicontrol" id="cce_01_0028_uicontrol6195174211124"><a name="cce_01_0028_uicontrol6195174211124"></a><a name="cce_01_0028_uicontrol6195174211124"></a>“加密设置”</span>对话框中，选择已有的密钥，若没有可选的密钥，请单击后方的链接创建新密钥，完成创建后单击刷新按钮。</li></ul>
    </div>
    </td>
    </tr>
