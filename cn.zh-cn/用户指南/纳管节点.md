...
3.  配置节点参数。
    ...
    **表 1**  计算配置参数
    ...
    <td class="cellrowborder" valign="top" width="79.97999999999999%" headers="mcps1.2.3.1.2 "><p id="p14938184183619"><a name="p14938184183619"></a><a name="p14938184183619"></a><strong id="b135868616379"><a name="b135868616379"></a><a name="b135868616379"></a>密码</strong></p>
    <p id="p1584594053611"><a name="p1584594053611"></a><a name="p1584594053611"></a>用户名默认为“root”，请输入登录节点的密码，并确认密码。</p>
    <p id="p1629673613013"><a name="p1629673613013"></a><a name="p1629673613013"></a>登录节点时需要使用该密码，请妥善管理密码，系统无法获取您设置的密码内容。</p>
    ...
    <p id="p16297136153013"><a name="p16297136153013"></a><a name="p16297136153013"></a>密钥对用于远程登录节点时的身份认证。若没有密钥对，可单击选项框右侧的“创建密钥对”来新建，创建密钥对操作步骤请参见<a href="https://support.huaweicloud.com/usermanual-ecs/zh-cn_topic_0014250631.html" target="_blank" rel="noopener noreferrer">创建密钥对</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
