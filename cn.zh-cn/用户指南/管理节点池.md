...
4.  在侧边栏滑出的“配置管理“窗口中，根据业务需求修改Kubernetes的参数值：
    ...
    **表 1**  配置管理参数
    ...
    <tr id="row1324313510019"><td class="cellrowborder" rowspan="2" valign="top" width="15.548445155484453%" headers="mcps1.2.5.1.1 "><p id="p168710101"><a name="p168710101"></a><a name="p168710101"></a>kube-proxy</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.486951304869514%" headers="mcps1.2.5.1.2 "><p id="p7766172314114"><a name="p7766172314114"></a><a name="p7766172314114"></a>conntrack-min</p>
    </td>
    <td class="cellrowborder" valign="top" width="40.925907409259075%" headers="mcps1.2.5.1.3 "><p id="p18475321011"><a name="p18475321011"></a><a name="p18475321011"></a>sysctl -w net.nf_conntrack_max</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.03869613038696%" headers="mcps1.2.5.1.4 "><p id="p103110392114"><a name="p103110392114"></a><a name="p103110392114"></a>131072</p>
    </td>
    </tr>
    <tr id="row578913135520"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p17766423411"><a name="p17766423411"></a><a name="p17766423411"></a>conntrack-tcp-timeout-close-wait</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" headers="mcps1.2.5.1.3 "><p id="p6316399119"><a name="p6316399119"></a><a name="p6316399119"></a>1h0m0s</p>
    </td>
    </tr>
    </tbody>
    </table>
...
您可以在CCE控制台中方便的迁移某个集群下节点池中的节点到其他节点池，从而实现节点在节点池间的灵活调配。

1.  登录[CCE控制台](https://console.huaweicloud.com/cce2.0/?utm_source=helpcenter)，在左侧导航栏中选择“资源管理 \> 节点池管理“。
2.  在集群选择框中，选择集群，可查看到当前集群下所有的节点池。
3.  单击待迁移的节点池名称后的“更多 \> 迁移“。（DefaultPool的“迁移“链接在节点池名称后直接显示）
