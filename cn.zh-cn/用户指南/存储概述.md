...
<td class="cellrowborder" valign="top" width="31.46%" headers="mcps1.2.5.1.4 "><p id="p18569134265811"><a name="p18569134265811"></a><a name="p18569134265811"></a>针对已经创建的<strong id="b149171340145819"><a name="b149171340145819"></a><a name="b149171340145819"></a>1.13及以下</strong>版本的集群，仍然使用已经安装的Flexvolume存储插件（<a href="storage-driver（系统资源插件-必装）.md">storage-driver</a>），CCE已停止更新该插件，您可以<a href="集群升级概述.md">升级集群版本</a>。</p>
</td>
</tr>
</tbody>
</table>
