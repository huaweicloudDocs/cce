...
-   [本地磁盘使用场景](#section12724113154514)
-   [主机路径\(HostPath\)挂载](#section196700523438)
-   [临时路径\(EmptyDir\)挂载](#section550555216467)
-   [配置项\(ConfigMap\)挂载](#section18638191594712)
-   [密钥\(Secret\)挂载](#section10197243134710)
-   [使用kubectl挂载主机路径](#section2432104516110)
...
2.  执行如下命令，配置名为“hostPath-pod-example.yaml”的创建Pod的yaml文件。
    ...
    **表 5**  本地磁盘储存依赖参数说明
    ...
    <table><thead align="left"><tr id="row1519121663519"><th class="cellrowborder" valign="top" width="26.102241101508717%" id="mcps1.2.3.1.1"><p id="p18191161619356"><a name="p18191161619356"></a><a name="p18191161619356"></a>参数</p>
    </th>
    <th class="cellrowborder" valign="top" width="73.89775889849129%" id="mcps1.2.3.1.2"><p id="p1919116161353"><a name="p1919116161353"></a><a name="p1919116161353"></a>描述</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row2318123021219"><td class="cellrowborder" valign="top" width="26.102241101508717%" headers="mcps1.2.3.1.1 "><p id="p9319103017129"><a name="p9319103017129"></a><a name="p9319103017129"></a>mountPath</p>
    </td>
    <td class="cellrowborder" valign="top" width="73.89775889849129%" headers="mcps1.2.3.1.2 "><p id="p1631923081216"><a name="p1631923081216"></a><a name="p1631923081216"></a>容器内挂载路径，示例中挂载到“/tmp”路径。</p>
    </td>
    </tr>
    <tr id="row163191830121220"><td class="cellrowborder" valign="top" width="26.102241101508717%" headers="mcps1.2.3.1.1 "><p id="p14319143031212"><a name="p14319143031212"></a><a name="p14319143031212"></a>hostPath</p>
    </td>
    <td class="cellrowborder" valign="top" width="73.89775889849129%" headers="mcps1.2.3.1.2 "><p id="p18319530131211"><a name="p18319530131211"></a><a name="p18319530131211"></a>主机路径，示例中主机路径为“/tmp”。</p>
    </td>
    </tr>
    </tbody>
    </table>
