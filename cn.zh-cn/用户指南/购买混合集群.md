...
2.  参照[表2](#table8638121213265)设置服务选型参数，其中带“\*”的参数为必填参数。
    ...
    **表 2**  创建集群参数配置
    ...
    <td class="cellrowborder" valign="top" width="79.97999999999999%" headers="mcps1.2.3.1.2 "><p id="p36131511317"><a name="p36131511317"></a><a name="p36131511317"></a>默认不开启。</p>
    <p id="p1656714414305"><a name="p1656714414305"></a><a name="p1656714414305"></a>开启后将自动创建IPv6地址的容器网段与服务网段，支持通过IPv6地址段访问集群资源，包括节点，工作负载等。具体请参见<a href="https://support.huaweicloud.com/bestpractice-cce/cce_bestpractice_0022.html" target="_blank" rel="noopener noreferrer">搭建IPv4/IPv6双栈集群（公测）</a>。</p>
    </td>
    </tr>
    ...
    <p id="p16141515161117"><a name="p16141515161117"></a><a name="p16141515161117"></a>开启RBAC能力后，设置了细粒度权限的IAM用户使用集群下资源将受到权限控制。详细请参见<a href="kubernetes-RBAC授权.md">kubernetes RBAC授权</a>。</p>
    </td>
    </tr>
    ...
    <div class="fignone" id="fig19782959108"><a name="fig19782959108"></a><a name="fig19782959108"></a><span class="figcap"><b>图1 </b>控制节点可用区选择</span><br><a name="image0463648706"></a><a name="image0463648706"></a><span><img id="image0463648706" src="figures/控制节点可用区选择.png" width="523.6875" height="67.631564"></span></div>
...
3.  单击“下一步：创建节点“，在“创建节点“步骤中，参照如下参数配置节点。
    ...
    -   **系统盘**和**数据盘：**设置节点磁盘空间。
        ...
        -   数据盘：
            ...
            -   云硬盘：规格为\[100, 32678\]GB，用户可以配置，缺省值为100GB。**节点类型为“磁盘增强型“和“超高I/O型“时显示该参数。**

                单击“数据盘空间分配“后的![](figures/zh-cn_image_0220692926.png)，可以对数据盘中的“k8s空间“和“用户空间“进行自定义设置。
            ...
            -   本地磁盘：**仅支持集群版本为v1.13.10-r0及以上且节点类型为“磁盘增强型“或“超高I/O型“时使用。**

                本地磁盘实例有宕机风险，不保证数据可靠性，建议您使用云硬盘存储业务数据。
            ...
            **图 5**  设置本地磁盘<a name="fig1660415328341"></a>  
