...
2.  参照[表2](#table8638121213265)设置服务选型参数，其中带“\*”的参数为必填参数。
    ...
    **表 2**  创建集群参数配置
    ...
    <p id="p16141515161117"><a name="p16141515161117"></a><a name="p16141515161117"></a>开启RBAC能力后，设置了细粒度权限的子用户使用集群下资源将受到权限控制。详细请参见<a href="kubernetes-RBAC授权.md">kubernetes RBAC授权</a>。</p>
    </td>
    </tr>
