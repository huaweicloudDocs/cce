...
2.  参照[表2](#table8638121213265)设置集群参数，其中带“\*”的参数需重点关注。
    ...
    **表 2**  创建集群参数配置
    ...
    <p id="p4145851202013"><a name="p4145851202013"></a><a name="p4145851202013"></a><strong id="b1266919520213"><a name="b1266919520213"></a><a name="b1266919520213"></a>Yangtse</strong></p>
    <p id="p146421738102017"><a name="p146421738102017"></a><a name="p146421738102017"></a>深度整合VPC原生ENI弹性网卡能力，采用VPC网段分配容器地址，支持ELB直通容器，享有高性能。</p>
    </td>
    </tr>
