...
-   [约束与限制](#section1274816104391)
-   [购买云硬盘存储卷](#section1727261664619)
-   [添加云硬盘存储卷](#section14273141619469)
-   [导入云硬盘存储卷](#section20275716134619)
-   [云硬盘包周期](#section84783474418)
-   [解关联云硬盘](#section0281191618462)
-   [相关操作](#section1683811402220)
...
2.  选择存储类型为“云硬盘“。
    ...
    **表 2**  挂载云硬盘参数配置
    ...
    </li><li>可用区：存储所在的可用区，自动分配存储仅支持Node节点所在可用区。</li><li>子类型：选择存储的子类型。<a name="ul14313174113435"></a><a name="ul14313174113435"></a><ul id="ul14313174113435"><li><span>高I/O：指由SAS存储介质构成的云硬盘。</span></li><li><span>普通I/O：指由SATA存储介质构成的云硬盘。</span></li><li><span>超高I/O：指由SSD存储介质构成的云硬盘</span>。</li></ul>
