...
-   [操作场景](#section196471258364)
-   [容器如何执行命令和参数](#section913591582414)
-   [启动命令](#section54912655316)
-   [启动后处理](#section15243544163715)
-   [停止前处理](#section2334114473712)
-   [容器重启策略](#section55383294287)
-   [设置容器生命周期-YAML样例](#section151181981167)
