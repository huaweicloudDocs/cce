...
2.  在“停止前处理“后，设置停止前处理的参数，如[表2](#table823614643810)。
    ...
    **表 3**  停止前处理-参数说明
    ...
    <pre class="screen" id="screen6420190132712"><a name="screen6420190132712"></a><a name="screen6420190132712"></a>exec: 
      ...
      - /install.sh 
      - install_agent</pre>
    <p id="p742120182716"><a name="p742120182716"></a><a name="p742120182716"></a>请在执行脚本中填写: /install install_agent。</p>
    <p id="p44211003277"><a name="p44211003277"></a><a name="p44211003277"></a>这条命令表示容器创建成功后将执行install_agent安装。</p>
    </td>
    </tr>
