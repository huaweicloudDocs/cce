...
3.  进入启用Istio服务网格页面，设置相关参数。
    ...
    网格类型为“托管控制面”时，请设置如下参数：

    -   计费模式

        当前仅支持按需计费，即后付费模式，按资源的实际使用时长计费，可以随时开通/删除资源。
    ...
    -   套餐
        ...
        当前支持体验版、专业版、企业版和铂金版四种套餐。不同套餐在支持管理的网格实例规模和功能上存在差异，请根据业务诉求按需选择。
...
5.  Istio服务网格启用成功后，可在“网格管理“或CCE的集群列表中查看Istio启用状态。
