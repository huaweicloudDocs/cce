...
3.  在创建节点池页面中，参照[表1](#table8638121213265)设置节点池选型参数，其中带“\*”的参数为必填参数。
    ...
    **表 1**  添加节点池参数配置
    ...
    <div class="fignone" id="fig831212511276"><a name="fig831212511276"></a><a name="fig831212511276"></a><span class="figcap"><b>图1 </b>设置本地磁盘</span><br><a name="image1463653352418"></a><a name="image1463653352418"></a><span><img id="image1463653352418" src="figures/设置本地磁盘-5.png" width="523.6875" height="193.054288"></span></div>
    </div>
    </td>
    </tr>
