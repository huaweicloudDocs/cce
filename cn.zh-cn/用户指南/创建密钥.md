...
1.  登录CCE控制台，在左侧导航栏中选择“配置中心  \>  密钥（Secret）“，单击“添加密钥“。
...
3.  方式一：直接创建密钥。
    ...
    **表 1**  基本信息说明
    ...
    <p id="p1331116369348"><a name="p1331116369348"></a><a name="p1331116369348"></a>如何获取证书请参见<a href="https://support.huaweicloud.com/usermanual-scm/scm_01_0221.html" target="_blank" rel="noopener noreferrer">购买证书</a>和<a href="https://support.huaweicloud.com/cce_faq/cce_faq_00185.html" target="_blank" rel="noopener noreferrer">自建证书</a>。</p>
    </div></div>
    </li></ul>
    </td>
    </tr>
