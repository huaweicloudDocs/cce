...
-   [依赖服务的权限设置](#section20316111417244)
-   [示例流程](#section129815361135)
-   [步骤一：验证用户当前权限](#section330722611126)
-   [步骤二：为用户组增加系统策略](#section10561192612817)
-   [步骤三：验证用户新增权限](#section787411356120)
...
-   Tenant Guest权限在您开启IAM系统策略授权之后将不再生效，也不会再有全局只读的效果。
...
1.  IAM用户“James”退出登录，使用华为云帐号登录[CCE控制台](https://console.huaweicloud.com/cce2.0/?utm_source=helpcenter)。
