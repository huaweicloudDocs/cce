...
-   依赖服务的权限配置均基于您已设置了IAM系统策略授权的CCE FullAccess或CCE ReadOnlyAccess策略权限，详细设置方法请参见[集群权限（IAM授权）](集群权限（IAM授权）-179.md)。
...
2.  在CCE控制台，单击左侧导航栏中的“权限管理“，在“集群权限“页签下单击“开发人员组”后的“设置权限“。
