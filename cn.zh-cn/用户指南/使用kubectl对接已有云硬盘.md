# 使用kubectl对接已有云硬盘<a name="cce_10_0313"></a>
    ...
    **1.11 ≤ K8s version < 1.11.7（1.11.7之前的1.11版本集群）**
    ...
    -   <a name="li19211184720504"></a>**PV yaml文件配置示例如下：**
        ...
        **表 3**  关键参数说明
        ...
        <td class="cellrowborder" valign="top" width="56.19%" headers="mcps1.2.3.1.2 "><p id="p14900354135717"><a name="p14900354135717"></a><a name="p14900354135717"></a>云硬盘类型，当前支持<span id="cce_10_0313_text1523372214318"><a name="cce_10_0313_text1523372214318"></a><a name="cce_10_0313_text1523372214318"></a>高I/O（SAS）、超高I/O（SSD）</span>。</p>
        </td>
        </tr>
    ...
    **K8s version = 1.9（1.9版本集群）**
    ...
    -   <a name="li813222310297"></a>**PV yaml文件配置示例如下：**
        ...
        **表 5**  关键参数说明
        ...
        <td class="cellrowborder" valign="top" width="56.19%" headers="mcps1.2.3.1.2 "><p id="p1213192316299"><a name="p1213192316299"></a><a name="p1213192316299"></a>云硬盘类型，当前支持<span id="cce_10_0313_text1523372214318_1"><a name="cce_10_0313_text1523372214318_1"></a><a name="cce_10_0313_text1523372214318_1"></a>高I/O（SAS）、超高I/O（SSD）</span>。</p>
        </td>
        </tr>
...
6.  （可选）增加集群关联的metadata，确保在删除节点或集群时避免删除已挂载的静态PV关联的EVS盘。
    ...
    3.  给EVS静态PV关联的EVS盘补充集群关联的metadata。
        ...
        **表 7**  关键参数说明
        ...
        <td class="cellrowborder" valign="top" width="71.26%" headers="mcps1.2.3.1.2 "><p id="p61617139512"><a name="p61617139512"></a><a name="p61617139512"></a>项目ID。</p>
        </td>
        </tr>
        ...
        <td class="cellrowborder" valign="top" width="71.26%" headers="mcps1.2.3.1.2 "><p id="p862733416319"><a name="p862733416319"></a><a name="p862733416319"></a>关联EVS盘的ID，配置为待创建静态PV中的volume_id，也可在EVS控制台，单击待导入的云硬盘名称，在磁盘详情界面的“概览信息”中获取ID的值，如<a href="#fig186361614133614">图1</a>。</p>
        </td>
        </tr>
        ...
        <td class="cellrowborder" valign="top" width="71.26%" headers="mcps1.2.3.1.2 "><p id="p173418474610"><a name="p173418474610"></a><a name="p173418474610"></a>待创建EVS PV的集群ID。在CCE控制台单击“资源管理 &gt; 集群管理”。单击待关联集群的名称，在集群详情页面，即可获取集群ID，如<a href="#fig3188153914187">图2</a>。</p>
        </td>
        </tr>
