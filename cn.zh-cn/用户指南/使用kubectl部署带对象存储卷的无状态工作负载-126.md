# 使用kubectl部署带对象存储卷的无状态工作负载<a name="cce_01_0327"></a>
...
2.  执行如下命令，配置名为“obs-deployment-example.yaml“的创建Pod的yaml文件。
    ...
    **表 2**  关键参数说明
    ...
    <td class="cellrowborder" valign="top" width="73.57000000000001%" headers="mcps1.2.3.1.2 "><p id="p8126203112"><a name="p8126203112"></a><a name="p8126203112"></a>工作负载对应的服务，服务创建过程请参见<a href="创建有状态负载(StatefulSet)-41.md">创建有状态负载(StatefulSet)</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
