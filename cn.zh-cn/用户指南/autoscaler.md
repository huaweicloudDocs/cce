...
2.  在安装插件页面，选择您要安装插件的集群和插件版本，单击“下一步“。
3.  参照[表1](#table1582194517429)配置插件安装参数。

    **表 1**  基本配置

    <a name="table1582194517429"></a>
    <table><thead align="left"><tr id="row178187453428"><th class="cellrowborder" valign="top" width="18.87%" id="mcps1.2.4.1.1"><p id="p14818104534219"><a name="p14818104534219"></a><a name="p14818104534219"></a>参数</p>
    </th>
    <th class="cellrowborder" valign="top" width="62%" id="mcps1.2.4.1.2"><p id="p181814453425"><a name="p181814453425"></a><a name="p181814453425"></a>参数说明</p>
    </th>
    <th class="cellrowborder" valign="top" width="19.13%" id="mcps1.2.4.1.3"><p id="p102901135192211"><a name="p102901135192211"></a><a name="p102901135192211"></a>支持的插件版本</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row178631475226"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.4.1.1 "><p id="p386464792210"><a name="p386464792210"></a><a name="p386464792210"></a>插件规格</p>
    </td>
    <td class="cellrowborder" valign="top" width="62%" headers="mcps1.2.4.1.2 "><p id="p1861133733913"><a name="p1861133733913"></a><a name="p1861133733913"></a>插件部署可选择<span class="uicontrol" id="uicontrol183682402402"><a name="uicontrol183682402402"></a><a name="uicontrol183682402402"></a>“单实例”</span>和<span class="uicontrol" id="uicontrol12789143104015"><a name="uicontrol12789143104015"></a><a name="uicontrol12789143104015"></a>“高可用”</span>两种规格。</p>
    ...
    <td class="cellrowborder" valign="top" width="19.13%" headers="mcps1.2.4.1.3 "><p id="p111958230594"><a name="p111958230594"></a><a name="p111958230594"></a>所有版本</p>
    </td>
    </tr>
    <tr id="row921611101579"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.4.1.1 "><p id="p13217111055715"><a name="p13217111055715"></a><a name="p13217111055715"></a>实例数</p>
    </td>
    <td class="cellrowborder" valign="top" width="62%" headers="mcps1.2.4.1.2 "><p id="p93701640145120"><a name="p93701640145120"></a><a name="p93701640145120"></a>选择上方插件规格后，显示插件中的实例数，此处仅作显示。</p>
    </td>
    <td class="cellrowborder" valign="top" width="19.13%" headers="mcps1.2.4.1.3 "><p id="p2264124945914"><a name="p2264124945914"></a><a name="p2264124945914"></a>所有版本</p>
    </td>
    </tr>
    <tr id="row087474432717"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.4.1.1 "><p id="p17875104414275"><a name="p17875104414275"></a><a name="p17875104414275"></a>容器</p>
    </td>
    <td class="cellrowborder" valign="top" width="62%" headers="mcps1.2.4.1.2 "><p id="p1437014065110"><a name="p1437014065110"></a><a name="p1437014065110"></a>选择插件规格后，显示插件容器的CPU和内存配额，此处仅作显示。</p>
    </td>
    <td class="cellrowborder" valign="top" width="19.13%" headers="mcps1.2.4.1.3 "><p id="p179441523596"><a name="p179441523596"></a><a name="p179441523596"></a>所有版本</p>
    </td>
    </tr>
    <tr id="row1166495115206"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.4.1.1 "><p id="p146651551122019"><a name="p146651551122019"></a><a name="p146651551122019"></a>登录方式</p>
    </td>
    <td class="cellrowborder" valign="top" width="62%" headers="mcps1.2.4.1.2 "><p id="p1011412155524"><a name="p1011412155524"></a><a name="p1011412155524"></a>为自动扩容node节点选择登录方式，当前支持<span class="uicontrol" id="uicontrol6266130175014"><a name="uicontrol6266130175014"></a><a name="uicontrol6266130175014"></a>“密码”</span>和<span class="uicontrol" id="uicontrol17468113316505"><a name="uicontrol17468113316505"></a><a name="uicontrol17468113316505"></a>“密钥对”</span>两种方式，您可根据需要进行选择。</p>
    ...
    <td class="cellrowborder" valign="top" width="19.13%" headers="mcps1.2.4.1.3 "><p id="p17242135513412"><a name="p17242135513412"></a><a name="p17242135513412"></a>部分版本无此参数</p>
    </td>
    </tr>
    <tr id="row7820124544210"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.4.1.1 "><p id="p7820184519425"><a name="p7820184519425"></a><a name="p7820184519425"></a><span class="keyword" id="keyword93481830179"><a name="keyword93481830179"></a><a name="keyword93481830179"></a>自动缩容</span></p>
    </td>
    <td class="cellrowborder" valign="top" width="62%" headers="mcps1.2.4.1.2 "><p id="p15974173353612"><a name="p15974173353612"></a><a name="p15974173353612"></a>默认不开启：将不开启自动缩容，只进行自动扩容。</p>
    ...
    <td class="cellrowborder" valign="top" width="19.13%" headers="mcps1.2.4.1.3 "><p id="p4606103215012"><a name="p4606103215012"></a><a name="p4606103215012"></a>所有版本</p>
    </td>
    </tr>
    <tr id="row10588111641417"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.4.1.1 "><p id="p20580042144816"><a name="p20580042144816"></a><a name="p20580042144816"></a>预置节点池配置</p>
    </td>
    <td class="cellrowborder" valign="top" width="62%" headers="mcps1.2.4.1.2 "><p id="p106311133304"><a name="p106311133304"></a><a name="p106311133304"></a>此为默认资源组。集群扩容时，若没有其他可用分组，将使用默认分组的资源规格进行扩容节点。</p>
    ...
    **表 2**  高级设置
    ...
    <table><thead align="left"><tr id="row4607144693512"><th class="cellrowborder" valign="top" width="18.529999999999998%" id="mcps1.2.4.1.1"><p id="p39151855123517"><a name="p39151855123517"></a><a name="p39151855123517"></a>参数</p>
    </th>
    <th class="cellrowborder" valign="top" width="62.629999999999995%" id="mcps1.2.4.1.2"><p id="p18915195517356"><a name="p18915195517356"></a><a name="p18915195517356"></a>参数说明</p>
    </th>
    <th class="cellrowborder" valign="top" width="18.84%" id="mcps1.2.4.1.3"><p id="p1412212191402"><a name="p1412212191402"></a><a name="p1412212191402"></a>插件版本</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row385043515351"><td class="cellrowborder" valign="top" width="18.529999999999998%" headers="mcps1.2.4.1.1 "><p id="p129911124203017"><a name="p129911124203017"></a><a name="p129911124203017"></a>节点总数</p>
    </td>
    <td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.4.1.2 "><p id="p29911924143017"><a name="p29911924143017"></a><a name="p29911924143017"></a>可扩容的最大节点总数。</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.84%" headers="mcps1.2.4.1.3 "><p id="p436632542"><a name="p436632542"></a><a name="p436632542"></a>所有版本</p>
    </td>
    </tr>
    <tr id="row1785163517352"><td class="cellrowborder" valign="top" width="18.529999999999998%" headers="mcps1.2.4.1.1 "><p id="p09919249305"><a name="p09919249305"></a><a name="p09919249305"></a>cpu总数（核）</p>
    </td>
    <td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.4.1.2 "><p id="p10991724113018"><a name="p10991724113018"></a><a name="p10991724113018"></a>可扩容的最大cpu总数（核）。</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.84%" headers="mcps1.2.4.1.3 "><p id="p16496194815118"><a name="p16496194815118"></a><a name="p16496194815118"></a>所有版本</p>
    </td>
    </tr>
    <tr id="row208511335113518"><td class="cellrowborder" valign="top" width="18.529999999999998%" headers="mcps1.2.4.1.1 "><p id="p7991152414302"><a name="p7991152414302"></a><a name="p7991152414302"></a>内存总数（GB）</p>
    </td>
    <td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.4.1.2 "><p id="p199916247301"><a name="p199916247301"></a><a name="p199916247301"></a>可扩容的最大内存总数（GB）。</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.84%" headers="mcps1.2.4.1.3 "><p id="p5197195215113"><a name="p5197195215113"></a><a name="p5197195215113"></a>所有版本</p>
    </td>
    </tr>
    <tr id="row12626156103612"><td class="cellrowborder" valign="top" width="18.529999999999998%" headers="mcps1.2.4.1.1 "><p id="p1627256173617"><a name="p1627256173617"></a><a name="p1627256173617"></a>自动扩容</p>
    </td>
    <td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.4.1.2 "><p id="p96272569366"><a name="p96272569366"></a><a name="p96272569366"></a><strong id="b83511403568"><a name="b83511403568"></a><a name="b83511403568"></a>未调度实例扩容：</strong>默认选中。</p>
    ...
    <td class="cellrowborder" valign="top" width="18.84%" headers="mcps1.2.4.1.3 "><p id="p5194172018453"><a name="p5194172018453"></a><a name="p5194172018453"></a>部分版本无此参数</p>
    </td>
    </tr>
    <tr id="row1242052163614"><td class="cellrowborder" valign="top" width="18.529999999999998%" headers="mcps1.2.4.1.1 "><p id="p162421452153620"><a name="p162421452153620"></a><a name="p162421452153620"></a>磁盘</p>
    </td>
    <td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.4.1.2 "><div class="p" id="p16199190205513"><a name="p16199190205513"></a><a name="p16199190205513"></a>系统盘和数据盘：设置节点磁盘空间。<a name="ul1220313142710"></a><a name="ul1220313142710"></a><ul id="ul1220313142710"><li>系统盘：规格为[40,1024]GB，用户可以配置，缺省值为40GB。</li><li>数据盘：规格为[100,32678]GB，用户可以配置，缺省值为100GB。<p id="p149151439185614"><a name="p149151439185614"></a><a name="p149151439185614"></a>勾选<span class="uicontrol" id="uicontrol5468812165717"><a name="uicontrol5468812165717"></a><a name="uicontrol5468812165717"></a>“资源分配自定义”</span>后，您可以对数据盘中的Docker和Kubelet资源占比进行自定义设置。</p>
    ...
    <td class="cellrowborder" valign="top" width="18.84%" headers="mcps1.2.4.1.3 "><p id="p9813132834516"><a name="p9813132834516"></a><a name="p9813132834516"></a>部分版本无此参数</p>
    </td>
    </tr>
    <tr id="row144889497367"><td class="cellrowborder" valign="top" width="18.529999999999998%" headers="mcps1.2.4.1.1 "><p id="p94899496360"><a name="p94899496360"></a><a name="p94899496360"></a>命令行注入</p>
    </td>
    <td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.2.4.1.2 "><p id="p124899494362"><a name="p124899494362"></a><a name="p124899494362"></a>请输入脚本命令。</p>
    ...
    <td class="cellrowborder" valign="top" width="18.84%" headers="mcps1.2.4.1.3 "><p id="p834518108397"><a name="p834518108397"></a><a name="p834518108397"></a>部分版本无此参数</p>
    </td>
    </tr>
    </tbody>
    </table>
