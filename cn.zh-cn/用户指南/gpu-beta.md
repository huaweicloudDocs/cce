...
3.  **插件版本为1.1.6以及之前时：**
    ...
    **插件版本为1.1.10时：**
    ...
    在规格配置页面，配置驱动链接地址。如何获取驱动链接，请参考[获取驱动链接方式](#section95451728192112)。

    >![](public_sys-resources/icon-caution.gif) **注意：** 
    >-   如果下载链接为公网地址，如nvidia官网地址'https://us.download.nvidia.com/tesla/396.37/NVIDIA-Linux-x86\_64-396.37.run'，各GPU节点均需要绑定EIP。
