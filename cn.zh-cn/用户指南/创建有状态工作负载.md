...
3.  （可选）若您希望通过YAML方式创建工作负载，您可单击界面右侧的“YAML创建“，通过yaml的方式创建工作负载。YAML编写完成后，可单击“创建“，直接创建工作负载。
...
5.  添加容器。
    ...
    2.  配置镜像参数。
        ...
        **表 2**  添加容器参数说明
        ...
        <td class="cellrowborder" valign="top" width="77%" headers="mcps1.2.3.1.2 "><p id="cce_01_0047_p65001729105011"><a name="cce_01_0047_p65001729105011"></a><a name="cce_01_0047_p65001729105011"></a>若选中，容器将获得超级权限，例如修改内核参数等功能。</p>
        </td>
        </tr>
    ...
    9.  （可选）一个实例包含1个或多个相关容器。若您的工作负载包含多个容器，请单击![](figures/icon-add-container.png)，再执行添加容器的操作。

6.  单击“下一步“，设置实例间发现服务，如[表3](#table9558885552)。
...
4.  若工作负载需要被访问（集群内访问、VPC内访问或公网访问），您需要设置访问方式，详情请参见[网络管理](网络管理.md)创建对应服务。
