...
-   [前提条件](#section14271608324)
-   [约束与限制](#section5807185714121)
-   [创建对象存储卷](#section172788131291)
-   [添加对象存储卷](#section152804130911)
-   [导入对象存储卷](#section1528121319910)
-   [解关联对象存储卷](#section0281121315919)
...
>-   获取永久访问密钥的方法，具体请参见[获取永久访问密钥（AK/SK）](https://support.huaweicloud.com/devg-obs/obs_06_0012.html)。
