...
该伸缩能力由[应用运维管理AOM](https://support.huaweicloud.com/aom/index.html)服务提供，v1.17及以上版本的集群不支持该伸缩能力。
...
2.  在“手动伸缩“策略下，单击![](figures/icon-edit-19.png)修改实例数量，例如修改为“3“，单击“保存“后实例伸缩操作即可生效。
