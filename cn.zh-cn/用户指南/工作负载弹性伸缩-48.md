...
该弹性伸缩能力通过创建HPA或CustomedHPA策略实现，**您可以前往[弹性伸缩](创建工作负载弹性伸缩（HPA）-169.md)查看所有策略，或进行更多操作。**
...
2.  在“手动伸缩“策略下，单击![](figures/icon-edit-55.png)修改实例数量，例如修改为“3“，单击“保存“后实例伸缩操作即可生效。
