...
<tbody><tr id="row190113461164"><td class="cellrowborder" valign="top" width="35.05%" headers="mcps1.2.3.1.1 "><p id="p15901194614161"><a name="p15901194614161"></a><a name="p15901194614161"></a>v1.11.7-r0</p>
</td>
...
5.  系统开始升级混合集群的版本，升级时间约为6分钟。

    **图 4**  开始升级混合集群版本<a name="fig15515150191312"></a>  
    ![](figures/开始升级混合集群版本.png "开始升级混合集群版本")
