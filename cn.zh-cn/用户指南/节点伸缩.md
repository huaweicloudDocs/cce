...
3.  在打开的“创建节点伸缩策略“页面中，参照[表1](#table8638121213265)设置策略参数。
    ...
    **表 1**  节点伸缩策略参数配置
    ...
    </li><li>执行动作：与上述<span class="uicontrol" id="uicontrol11314145173716"><a name="uicontrol11314145173716"></a><a name="uicontrol11314145173716"></a>“触发条件”</span>相对应，达到触发条件值后所要执行的动作。如<a href="#fig515211863120">图1</a>中所示，当内存分配率超过40%时将增加5个节点。<div class="fignone" id="fig515211863120"><a name="fig515211863120"></a><a name="fig515211863120"></a><span class="figcap"><b>图1 </b>指标触发-执行动作</span><br><a name="image1734771352112"></a><a name="image1734771352112"></a><span><img id="image1734771352112" src="figures/指标触发-执行动作.png" width="523.6875" height="322.676088"></span></div>
    </li></ul>
