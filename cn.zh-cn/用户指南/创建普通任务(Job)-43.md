...
3.  参照[表1](#t70ce3a99637a44ce8f7274857fb245b1)配置任务基本信息，其中带“\*”标志的参数为必填参数。
    ...
    **表 1**  任务基本信息
    ...
    <p id="p10118529112613"><a name="p10118529112613"></a><a name="p10118529112613"></a>两种容器运行时的对比请参见<a href="节点概述-24.md#section7201124294111">普通容器与安全容器的区别</a>。</p>
    </td>
    </tr>
