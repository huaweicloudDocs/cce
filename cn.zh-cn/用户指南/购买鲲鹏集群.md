...
3.  设置集群参数，其中带“\*”的参数需重点关注。
    ...
    **表 1**  创建集群参数配置
    ...
    <td class="cellrowborder" valign="top" width="79.97999999999999%" headers="mcps1.2.3.1.2 "><p id="p1363744211114"><a name="p1363744211114"></a><a name="p1363744211114"></a>该参数仅对开通企业项目的企业客户帐号显示。选择某企业项目（如：default）后，集群、集群下节点、集群安全组、节点安全组和自动创建的<span id="ph1945745153214"><a name="ph1945745153214"></a><a name="ph1945745153214"></a>节点EIP（弹性公网IP）</span>将创建到所选企业项目下。<span id="ph1824713573305"><a name="ph1824713573305"></a><a name="ph1824713573305"></a>为方便管理资源，在集群创建成功后，建议不要修改集群下节点、集群安全组、节点安全组的企业项目。</span></p>
