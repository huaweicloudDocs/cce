...
3.  参照[表1](#zh-cn_topic_0107283640_table8638121213265)设置服务选型参数，其中带“\*”的参数为必填参数。
    ...
    **表 1**  创建集群参数配置
    ...
    <td class="cellrowborder" valign="top" width="79.97999999999999%" headers="mcps1.2.3.1.2 "><p id="p716419516599"><a name="p716419516599"></a><a name="p716419516599"></a>集群创建成功后，网络模型不可更改，请谨慎选择。</p>
    ...
    <div class="fignone" id="fig19782959108"><a name="fig19782959108"></a><a name="fig19782959108"></a><span class="figcap"><b>图1 </b>控制节点可用区选择</span><br><a name="image0463648706"></a><a name="image0463648706"></a><span><img id="image0463648706" src="figures/控制节点可用区选择-1.png" width="413.63" height="53.418253"></span></div>
