# 使用kubectl部署带对象存储卷的有状态工作负载<a name="cce_01_0328"></a>
...
1.  参照[创建对象存储卷](使用对象存储卷-123.md#section172788131291)中操作创建对象存储卷，并获取PVC名称。
...
3.  新建一个YAML文件，用于创建工作负载。假设文件名为**obs-statefulset-example.yaml**。
    ...
    **表 1**  关键参数说明
    ...
    <td class="cellrowborder" valign="top" width="73.57000000000001%" headers="mcps1.2.3.1.2 "><p id="p1090712121565"><a name="p1090712121565"></a><a name="p1090712121565"></a>工作负载对应的服务，服务创建过程请参见<a href="创建有状态负载(StatefulSet)-41.md">创建有状态负载(StatefulSet)</a>。</p>
    </td>
    </tr>
